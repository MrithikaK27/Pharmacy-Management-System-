...
$getQuantity=mysqli_query($conn, "SELECT DISTINCT quantity FROM invoice_details WHERE id='{$invoice}'");
...
echo "<tr>";
				...
				echo'<td align="right">'. number_format($zote) . '</td>';
					
fwrite($file, "TOTAL;;;".$zot.";\n");
fclose($file);
echo "</table>"; 				
